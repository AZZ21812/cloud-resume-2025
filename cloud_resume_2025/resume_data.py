...
This file contains all professional information used by the chatbot and ATS generator
"""
...
def get_formatted_resume() -> str:
    """Returns a formatted resume string for use in prompts"""
...
"""
    ...
    resume += f"\n=== EDUCATION ===\n"
    resume += f"{EDUCATION['degree']} | {EDUCATION['university']} | {EDUCATION['period']}\n"
    resume += f"Relevant Coursework: {', '.join(EDUCATION['coursework'])}\n"
